...
public class ItemArrowBase extends Item
{
	...
	public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List informationList, boolean unknown)
	{
		...
		case 2: informationList.add("30% chance of breaking"); informationList.add("Bleeding"); informationList.add(""); informationList.add(Color.BLUE + "+" + damageModifier + " Attack Damage"); break;
		...
		case 7: informationList.add("15% chance of breaking"); informationList.add("Breaks on armor"); informationList.add("Poison"); informationList.add("Very accurate"); informationList.add(""); informationList.add(Color.BLUE + "+" + damageModifier + " Attack Damage"); break;
